...
<AccordionGroup>
  <Accordion title="You’ve given feedback on a ticket, do you move it back to To do?" defaultOpen>
    No. If you have actionable feedback, create sub-tickets for it. Those sub-tickets should go to To do.
  </Accordion>
  <Accordion title="I have now addressed all sub-tickets after feedback, what should I do?" defaultOpen>
  ...
  <Accordion title="I have a feature idea but it’s not crucial right now, where should it go?" defaultOpen>
